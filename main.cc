...
int main(int argc, char *argv[])
{
    ...
    configure_ann_search_from_env();
    print_ann_search_config();
    ann_prepare_index(base, base_number, vecdim);
    ...
    for(int i = 0; i < test_number; ++i) {
        ...
        auto res = ann_search_dispatch(base, test_query + i*vecdim, base_number, vecdim, k);
